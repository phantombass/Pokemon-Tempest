#===============================================================================
#  Elite Battle: DX pre-defined battle scene configurations.
#
...
#===============================================================================
#  TODO compatibility layer for seasonal definitions
module EBEnvironment
  ...
  UNDERWATER = {
    ...
    }, "bubbles" => true, "outdoor" => false, "underwater" => true # :TODO keep in mind to maybe disable rain/snow animations underwater
  }
  #-----------------------------------------------------------------------------
  FOREST = {
