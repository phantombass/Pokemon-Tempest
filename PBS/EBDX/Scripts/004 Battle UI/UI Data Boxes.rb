...
class DataBoxEBDX  <  SpriteWrapper
  ...
  def applyMetrics
    ...
    d7 = EliteBattle.getData($game_map.map_id, PBMap, :DATABOX_METRICS)
    # look up trainer specific metrics
    d6 = @battle.opponent ? EliteBattle.getTrainerData(@trainer.trainertype, :DATABOX_METRICS, @trainer) : nil
