...
def pbPrepareBattle(battle)
  ...
  if battleRules["defaultWeather"].nil?
    ...
    when PBFieldWeather::Overcast
      battle.defaultWeather = PBWeather::Overcast
    when PBFieldWeather::Eclipse
      battle.defaultWeather = PBWeather::Eclipse
    when PBFieldWeather::Humid
      battle.defaultWeather = PBWeather::Humid
    when PBFieldWeather::HeatLight
      battle.defaultWeather = PBWeather::HeatLight
    when PBFieldWeather::Rainbow
      battle.defaultWeather = PBWeather::Rainbow
    when PBFieldWeather::VolcanicAsh
      battle.defaultWeather = PBWeather::VolcanicAsh
    when PBFieldWeather::Windy
      battle.defaultWeather = PBWeather::Windy
    when PBFieldWeather::DClear
      battle.defaultWeather = PBWeather::DClear
    when PBFieldWeather::DWind
      battle.defaultWeather = PBWeather::DWind
    when PBFieldWeather::DRain
      battle.defaultWeather = PBWeather::DRain
    when PBFieldWeather::DAshfall
      battle.defaultWeather = PBWeather::DAshfall
    when PBFieldWeather::DustDevil
      battle.defaultWeather = PBWeather::DustDevil
    when PBFieldWeather::AcidRain
      battle.defaultWeather = PBWeather::AcidRain
    ...
    when PBFieldWeather::HeavyRain
      battle.defaultWeather = PBWeather::HeavyRain
    when PBFieldWeather::HarshSun
      battle.defaultWeather = PBWeather::HarshSun
    when PBFieldWeather::Fog
      battle.defaultWeather = PBWeather::Fog
    when PBFieldWeather::TimeWarp
      battle.defaultWeather = PBWeather::TimeWarp
    when PBFieldWeather::Reverb
      battle.defaultWeather = PBWeather::Reverb
    when PBFieldWeather::None
      battle.defaultWeather = PBWeather::None
    end
  else
...
def pbGetEnvironment
  ...
  when PBTerrain::Distortion;                  ret = PBEnvironment::Distortion
