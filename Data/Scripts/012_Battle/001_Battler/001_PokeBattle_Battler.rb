...
#      :FLOWERGIFT,                                        # This can be stopped
  ...
  def takesSandstormDamage?
    ...
    return false if pbHasType?(:GROUND) || pbHasType?(:ROCK) || pbHasType?(:STEEL) || hasActiveAbility?(:BAROMETRIC)
  ...
  def takesDustDevilDamage?
    return false if !takesIndirectDamage?
    return false if pbHasType?(:GROUND) || pbHasType?(:FLYING) || hasActiveAbility?(:BAROMETRIC)
    return false if inTwoTurnAttack?("0CA","0CB")   # Dig, Dive
    return false if hasActiveAbility?([:OVERCOAT,:SANDFORCE,:SANDRUSH,:SANDVEIL])
    return false if hasActiveItem?(:SAFETYGOGGLES)
    return true
  ...
  def takesAcidRainDamage?
    return false if !takesIndirectDamage?
    return false if pbHasType?(:POISON) || pbHasType?(:STEEL) || hasActiveAbility?(:BAROMETRIC)
    return false if inTwoTurnAttack?("0CA","0CB")   # Dig, Dive
    return false if hasActiveAbility?([:OVERCOAT,:SANDFORCE,:SANDRUSH,:SANDVEIL])
    return false if hasActiveItem?(:SAFETYGOGGLES)
    return true
  ...
  def takesHailDamage?
    return false if !takesIndirectDamage?
    return false if pbHasType?(:ICE) || hasActiveAbility?(:BAROMETRIC)
    return false if inTwoTurnAttack?("0CA","0CB")   # Dig, Dive
  ...
  def takesStarstormDamage?
    return false if !takesIndirectDamage?
    return false if pbHasType?(:COSMIC) || hasActiveAbility?(:BAROMETRIC)
    return false if inTwoTurnAttack?("0CA","0CB")   # Dig, Dive
    return false if hasActiveAbility?(:STARSPRINT)
    return false if hasActiveItem?(:SAFETYGOGGLES)
    return true
  end
