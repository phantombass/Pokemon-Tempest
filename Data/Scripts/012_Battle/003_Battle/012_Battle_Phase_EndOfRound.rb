  ...
  def pbEORWeather(priority)
    ...
    if @field.weatherDuration==0
      ...
      when PBWeather::Starstorm
        pbDisplay(_INTL("The stars have faded."))
      when PBWeather::Storm
        pbDisplay(_INTL("The storm has calmed."))
      when PBWeather::Humid
        pbDisplay(_INTL("The humidity has lowered."))
      when PBWeather::Overcast
        pbDisplay(_INTL("The clouds have cleared."))
      when PBWeather::Eclipse
        pbDisplay(_INTL("The sky brightened."))
      when PBWeather::Fog
        pbDisplay(_INTL("The fog has lifted."))
      when PBWeather::AcidRain
        pbDisplay(_INTL("The acid rain has stopped."))
      when PBWeather::VolcanicAsh
        pbDisplay(_INTL("The ash dissolved."))
      when PBWeather::Rainbow
        pbDisplay(_INTL("The rainbow disappeared."))
      when PBWeather::Borealis
        pbDisplay(_INTL("The sky has calmed."))
      when PBWeather::DClear
        pbDisplay(_INTL("The sky returned to normal."))
      when PBWeather::DRain
        pbDisplay(_INTL("The rain has stopped."))
      when PBWeather::DWind
        pbDisplay(_INTL("The wind has passed."))
      when PBWeather::DAshfall
        pbDisplay(_INTL("The ash disintegrated."))
      when PBWeather::Sleet
        pbDisplay(_INTL("The sleet lightened."))
      when PBWeather::Windy
        pbDisplay(_INTL("The wind died down."))
      when PBWeather::HeatLight
        pbDisplay(_INTL("The air has calmed."))
      when PBWeather::TimeWarp
        pbDisplay(_INTL("Time began to move again."))
      when PBWeather::Reverb
        pbDisplay(_INTL("Silence fell once more."))
      when PBWeather::DustDevil
        pbDisplay(_INTL("The dust devil dissipated."))
      end
  ...
  def pbEndOfRoundPhase
    ...
    priority.each do |b|
      ...
      recipient.pbRecoverHPFromDrain(hpLoss,b,
         _INTL("{1}'s health is sapped!",b.pbThis))
