  ...
  def pbFindMoveAnimation(moveID,idxUser,hitNum)
    begin
      ...
      typeDefaultAnim = {
         ...
         :COSMIC   => [:SHADOWPUNCH,:SILVERWIND,:COSMICPOWER,nil,:SWIFT,:COSMICPOWER],
         :TIME     => [:MACHPUNCH,:CONFUSION,:CALMMIND,nil,:SILVERWIND,:COSMICPOWER],
         :SOUND    => [:VACUUMWAVE,:HYPERVOICE,:HOWL,nil,:BOOMBURST,:METALSOUND]
      }
