...
BattleHandlers::EORWeatherAbility.add(:ACCLIMATE,
  proc { |ability,weather,battler,battle|
    ...
    when 17
      ...
      when 3,10; newWeather = 14
      when 12,14,19; newWeather = 18
    ...
    when 19
      case type2
      when 8, 21; newWeather = 6
      when 4; newWeather = 13
      when 7; newWeather = 7
      when 3, 1; newWeather = 17
      when 15, 12, 6; newWeather = 1
      when 0,2,5,9,10,11,13,14,16,17,18,19,20, nil; newWeather = 19
      end
    when 20
      case type2
      when 0, 17; newWeather = 11
      when 8, 11, 14, 2; newWeather = 20
      when 1,3,4,5,6,7,9,10,12,13,15,16,18,19,20,21, nil; newWeather = 5
      end
    when 21
      case type2
...
BattleHandlers::AbilityOnSwitchIn.add(:DESERTSTORM,
  proc { |ability,battler,battle|
    next if battle.field.weather == PBWeather::DustDevil
    pbBattleWeatherAbility(PBWeather::DustDevil,battler,battle)
  }
)

BattleHandlers::AbilityOnSwitchIn.add(:ASHCOVER,
  proc { |ability,battler,battle|
    next if battle.field.weather == PBWeather::VolcanicAsh
    pbBattleWeatherAbility(PBWeather::VolcanicAsh,battler,battle)
  }
)
