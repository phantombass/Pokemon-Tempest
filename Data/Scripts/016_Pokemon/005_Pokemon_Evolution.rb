module PBEvolution
  ...
  def self.maxValue; return 71; end
...
PBEvolution.register(:ZharoPoochyena, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
    mapPos = pbGetMetadata($game_map.map_id, MetadataMapPosition)
    return false if (mapPos && mapPos[0]) != 0
    next pkmn.level >= parameter
  }
})

PBEvolution.register(:ZharoPhanpy, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
    mapPos = pbGetMetadata($game_map.map_id, MetadataMapPosition)
    return false if (mapPos && mapPos[0]) != 0
...
PBEvolution.register(:ZharoDrowzee, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
    mapPos = pbGetMetadata($game_map.map_id, MetadataMapPosition)
    return false if (mapPos && mapPos[0]) != 0
...
PBEvolution.register(:Ferrocuda, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
...
PBEvolution.register(:Flarocuda, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
...
PBEvolution.register(:Fearocuda, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
...
PBEvolution.register(:Fairicuda, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
...
PBEvolution.register(:Floracuda, {
  "minimumLevel" => 1,   # Needs any level up
  "levelUpCheck" => proc { |pkmn, parameter|
