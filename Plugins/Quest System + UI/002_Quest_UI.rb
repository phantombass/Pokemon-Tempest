...
#===============================================================================
# Utility method for picking colors
#===============================================================================
...
class QuestList_Scene
  ...
  def pbStartScene
	...
	addBackgroundPlane(@sprites,"bg_1","QuestUI/bg_1",@viewport)
	@sprites["bg_2"] = IconSprite.new(0,0,@viewport)
	@sprites["bg_2"].setBitmap("Graphics/Pictures/QuestUI/bg_2")
	@sprites["page_icon1"] = IconSprite.new(0,4,@viewport)
	@sprites["page_icon1"].setBitmap("Graphics/Pictures/QuestUI/page_icon1")
    ...
    @quests = [
	  ...
	  $PokemonGlobal.quests.failed_quests
	]
	@quests_text = ["Active", "Completed", "Failed"]
	@current_quest = 0
    ...
    drawFormattedTextEx(@sprites["overlay_control"].bitmap,348,316,
        436,"<c2=#{colorQuest("red")}>New Quest:</c2>",@base,@shadow)
