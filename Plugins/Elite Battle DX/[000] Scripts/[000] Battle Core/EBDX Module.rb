...
module EliteBattle
  ...
  def self.follower(battle)
    return (EliteBattle::USE_FOLLOWER_EXCEPTION && $PokemonGlobal && $PokemonGlobal.respond_to?(:follower_toggled) && $PokemonGlobal.follower_toggled && battle.scene.firstsendout) ? 0 : nil
  end
  #-----------------------------------------------------------------------------
